/*
 * ================================================================
 * events.js — alle eventer i påby
 * ================================================================
 *
 * Slik legger du til et event:
 *   1. Kopier MAL-objektet nedenfor
 *   2. Fyll inn feltene (se forklaring under)
 *   3. Legg objektet til i EVENTER-arrayen
 *   4. Lagre og last inn appen på nytt — ferdig
 *
 * ----------------------------------------------------------------
 * MAL — kopier denne blokken og fyll inn:
 *
 * {
 *   tittel:      'Navn på eventet',           // PÅKREVD
 *   kategori:    'musikk',                    // PÅKREVD — 'musikk' | 'mat' | 'klubb'
 *   sted:        'Venuenavn',                  // PÅKREVD
 *   adresse:     'Gateadresse, Oslo',          // valgfri
 *   lat:         59.9133,                      // valgfri — GPS-breddegrad (for avstand/kart)
 *   lng:         10.7388,                      // valgfri — GPS-lengdegrad (for avstand/kart)
 *   start:       '2026-06-26T21:00',           // PÅKREVD — format: YYYY-MM-DDTHH:MM
 *   pris:        0,                            // PÅKREVD — tall i kr. 0 = gratis
 *   beskrivelse: 'En setning eller to.',       // valgfri
 *   lenke:       'https://billett.no/...',     // valgfri — billett / mer info
 *   bilde:       'https://...',                // valgfri — URL eller lokal sti (bilder/navn.jpg)
 * }
 *
 * Tips:
 *   - Du trenger ikke id — den utledes automatisk fra tittel + dato
 *   - Mangler lat/lng vises kortet pent uten avstand og uten kart-knapp
 *   - Mangler bilde vises en fargeflate i stedet
 *   - Dag og ukedag utledes automatisk fra start-feltet
 *   - Eventer som har passert skjules automatisk
 * ================================================================
 */
